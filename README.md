...
- **[PromptScan](https://promptscan.dev)** - Real-time prompt injection detection API for AI agents. Scan untrusted text before passing it to an LLM — returns injection_detected, attack_type, and confidence.
